...
df = pd.read_csv('/workspace/Logistic-Regression-Project/data/processed/df_processed.csv')
...
filename = '/workspace/Logistic-Regression-Project/models/model_logisticReg.sav'
